 ...
 * `Node` + other classes: Provides a platform agnostic way for creating and assembling VPLs. This system could easily be ported to many other platforms and input systems, such as VR.
 ...
 * `DrawingCanvas`: Simple and flexible view for drawing.
 ...
 Full source available on GitHub [here](https://github.com/NathanFlurry/VisualProgrammingLanguage). Source includes a standalone application so you can have more space to write your programs.
