/*:
 Welcome to the world of visual programming! This playground aims to demonstrate the basics visual programming and its potential. This book will cover the basics of how to use this flavor of [VPL](glossary://VPL), show some examples, and demonstrate how to customize the VPL to add your own features.
 
 + Note:
 This playground assumes that the users is familiar with basic programming concepts, such as control flow and variables.
 
 Visual programs are constructed on a 2D canvas, such as the one you see to the right. Right now, you should see a program that prints "EVEN" if the variable is even. Use two fingers to pan canvas and look around. Take a look at the bottom panel to see the code that is generated by the diagram.
 ...
 + Note:
 The drawing pad for the `Integer` and `String Constant` nodes scroll to the right once you reach the gray area  of the drawing area so you can write longer strings.
 ...
 **Congratulations!** You just finished your first visual program. 🎉
 ...
 + Callout(Challenge):
 Try adding another `If` node after the first to determine if the number is divisible evenly by 3.
